...
class PagingSimulation: # 9+9+9+9+12 bits per virtual address
    ...
    def __init__(self, ram_bytes, offsetbits):
        ...
        self.CR3 = NULL
        self.freeframe = 0 # counter for currently free frame, frame 0 is reserved and not used
        ...
        self.tlb = None # Todo: add code here for data structure simulating TLB entries
    ...
    def tlb_lookup(self, pagenr):
        ...
        return NULL # ADD CODE HERE FOR TLB
    ...
    def print_pagetable_sizes1(self): ## Using only One Level
        print("\n=== MEMORY STATE ===")
        print(f"Total frames used: {self.freeframe}")
        print(f"Total memory used by page tables: {self.freeframe * self.pagesize} bytes")
...
pt.print_pagetable_sizes()
pt.print_pagetable_sizes1()
